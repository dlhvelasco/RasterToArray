...
subprocess.call(["gdalbuildvrt", "stacktest5.vrt", "-resolution", "highest", "-srcnodata", "-9999",                     #Saved in RasterToArray folder
...
with rasterio.open("stacktest5.vrt", 'r') as ds: #Saved in RasterToArray folder
